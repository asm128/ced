...
void												ced::transformInertiaTensor			(::ced::SMatrix3<float> & iitWorld, const ::ced::SMatrix3<float> &iitBody, const ::ced::SMatrix4<float> &rotmat)		{
...
void												ced::updateTransform					(::ced::STransform3 & bodyTransform, ::ced::SMatrix4<float> & transformLocal)	{
...
int32_t												ced::integrateForces					(double duration, ::ced::SRigidBodyFrame& bodyFrame, ::ced::SForce3 & bodyForce, const ::ced::SMass3 & bodyMass) {
	...
	::ced::SCoord3<float>									angularAcceleration						= bodyFrame.InverseInertiaTensorWorld.Transform(bodyFrame.AccumulatedTorque);
