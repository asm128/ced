...
#ifndef CED_MATRIX_H_298374982374
#define CED_MATRIX_H_298374982374
...
#pragma pack(push, 1)
	...
	struct SMatrix4 {
		...
		//	};
		//}
								void				Viewport					(const ::ced::SCoord2<uint32_t> & offscreenMetrics)			noexcept	{
			...
			*this									=
			...
			::ced::SPairSinCos							angleSinCos					= ::ced::getSinCos(angle);
		...
		//	return *this;
			...
			_44										= (_tBase)1;
							...
							void				SetOrientation				(const ::ced::SQuaternion<_tBase>& qo)																	{
		...
		constexpr			_TCoord3D			TransformInverse			(const _TCoord3D& _v)															const	noexcept	{
			...
			*this =
				...
				,	(_tBase)0,  (_tBase)0,  (_tBase)1
							...
							void				RotationX					(double angle)																			noexcept	{
			::ced::SPairSinCos							angleSinCos					= {sin(angle), cos(angle)};
			_11 = (_tBase)1;	_12 =							_13 =
			_31 = (_tBase)0;	_32 = -(_tBase)angleSinCos.Sin;	_33 = (_tBase)angleSinCos.Cos;
			_21 = (_tBase)0;	_22 =  (_tBase)angleSinCos.Cos;	_23 = (_tBase)angleSinCos.Sin;
		}
...
#endif // CED_MATRIX_H_298374982374
